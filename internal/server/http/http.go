...
import (
	...
	mfserver "github.com/mainflux/mfxkit/internal/server"
)
...
func New(ctx context.Context, cancel context.CancelFunc, name string, config mfserver.Config, handler http.Handler, logger mflog.Logger) mfserver.Server {
